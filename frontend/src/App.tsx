      ...
      <div className=" min-h-screen flex flex-col" >
        <div className="navbar bg-primary ">
          <div className="flex-1 text-neutral-content">
            <a className="btn btn-ghost text-xl"> Granimal</a>
          </div>
        ...
        <></>
        <div className='min-h-screen flex flex-grow'/**Contenuto**/>
          <></>
          <ul className="menu neutral-content w-44" /**MENU**/>
            <li>
          ...
          <></>
          <div className='hero min-h' bg-base-content>
